...
export const EntryPointV07SimulationsAbi = [
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'accountValidationData', type: 'uint256', internalType: 'uint256' },
          { name: 'paymasterValidationData', type: 'uint256', internalType: 'uint256' },
          { name: 'paymasterVerificationGasLimit', type: 'uint256', internalType: 'uint256' },
          { name: 'paymasterPostOpGasLimit', type: 'uint256', internalType: 'uint256' },
        ...
        components: [
          {
            ...
            components: [
              ...
              { name: 'accountValidationData', type: 'uint256', internalType: 'uint256' },
              { name: 'paymasterValidationData', type: 'uint256', internalType: 'uint256' },
              { name: 'paymasterContext', type: 'bytes', internalType: 'bytes' },
            ],
          },
          {
            name: 'senderInfo',
  ...
  { type: 'error', name: 'SenderAddressResult', inputs: [{ name: 'sender', type: 'address', internalType: 'address' }] },
  { type: 'error', name: 'SignatureValidationFailed', inputs: [{ name: 'aggregator', type: 'address', internalType: 'address' }] },
]
