methods {
    ...
    function _.totalSupply()                                    external => totalSupplyByToken[calledContract] expect uint256;
    function _.balanceOf(address a)                             external => balanceByToken[calledContract][a] expect uint256;
    function _.allowance(address a, address b)                  external => allowanceByToken[calledContract][a][b] expect uint256;
