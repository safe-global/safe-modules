module.exports = (web3) => {
  ...
  function getParamFromTxEvent(transaction, eventName, paramName, contractAddress, contractFactory, subject) {
      // TODO choose or not to use asserts (see chai library used by Truffle)
