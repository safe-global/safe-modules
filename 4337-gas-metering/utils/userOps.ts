...
export const submitUserOperationPimlico = async (
  ...
  if (chain == "mumbai") {
    console.log(
      `Transaction Link: https://mumbai.polygonscan.com/tx/${receipt.receipt.transactionHash}`,
    );
  } else {
    console.log(
...
export const getFeeValuesFromAlchemy = async (
  chain: string,
  apiKey: string,
) => {
  const feeOptions = {
  ...
  if (rvBlock && rvBlock.baseFeePerGas) {
    maxFeePerGas =
      ((BigInt(rvBlock.baseFeePerGas._hex) + BigInt(maxPriorityFeePerGas)) *
        15n) /
      10n; // Adding a buffer. Recommended is atleast 50%.
      ...
      params: [
        {
          ...
          maxPriorityFeePerGas:
            sponsoredUserOperation.maxPriorityFeePerGas.toString(16),
      ...
      params: [
        {
          ...
          verificationGasLimit:
            sponsoredUserOperation.verificationGasLimit.toString(16),
          preVerificationGas:
            sponsoredUserOperation.preVerificationGas.toString(16),
          maxFeePerGas: sponsoredUserOperation.maxFeePerGas.toString(16),
          maxPriorityFeePerGas:
            sponsoredUserOperation.maxPriorityFeePerGas.toString(16),
          signature: sponsoredUserOperation.signature,
