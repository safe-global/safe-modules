 ...
 */
contract GetConfigurationProxyHarness {
    /**
    ...
    function getConfiguration() external returns (uint256 x, uint256 y, P256.Verifiers verifiers) {
        ...
        assembly {
            ...
            let success := staticcall(gas(), singleton, data, add(calldatasize(), 0x56), 0, 0)
